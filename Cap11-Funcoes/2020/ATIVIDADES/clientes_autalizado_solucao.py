...
def imprime_uma_linha():
    registro = []
    for i in range(8):
        # print(i)
        #print(clientes[i])
        registro.append(clientes[i])
    yield registro

# for line in imprime_uma_linha():
#     print(line)
...
def valida_email():
    for line in imprime_uma_linha():
        #print(line)
        nome_completo = line[0]
        email = line[3]
        #print(nome_completo,email)
        nome, s_nome = nome_completo.split()
        #print(nome)
        #print(s_nome)
        email_atualizado = f'{nome.lower()}.{s_nome.lower()}@email.com'
        #print(email_atualizado)
        return email_atualizado
...
# 2
lista_de_empresas = ['Jeep Automobile']
...
# 4 inserir conteudo atualizado
# print(valida_email())
# print(valida_telefone())
# print(valida_data())

def valida_campos():
    for registro in imprime_uma_linha():
        #print(registro)
        registro.pop(3)
        #print(registro)
        ...
        registro.insert(3, email_valido)
        #print(registro)
        registro.pop(4)

        # telefone
        #print(registro)
        telefone_valido = valida_telefone()
        registro.insert(4,telefone_valido)
        #print(registro)
...
# print(imprime_uma_linha())
# print(next(imprime_uma_linha()))
# print(next(imprime_uma_linha()))

def valida_campos_2(linha):

    print(type(linha))
    for registro in list(linha):
        # email
        registro.pop(3)
        email_valido = valida_email()
        registro.insert(3, email_valido)
...
# l = imprime_uma_linha()
# print(valida_campos_2(l))

cliente = iter(clientes)

def get_uma_linha(cliente):
    for i in range(8):
        print(next(cliente))
    print()

get_uma_linha(cliente)

def imprime_uma_linha_2(lines):
    registro = []
    for i in range(8):
        # print(i)
        #print(clientes[i])
...
clientes_2 = []
for lines in iter(clientes):
    registros = next(imprime_uma_linha_2(lines))
    clientes_2.append(registros)
